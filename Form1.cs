...
namespace 六合分析软件
{
    public partial class Form1 : Form
    {
        ...
        const int HomePredictionPeriods = 200;
        AIEngine.PredictResult? _cachedPredict;
        EnsemblePredictionService.PredictionReport? _cachedEnsemble;
        ...
        private void ShowHome()
        {
            ...
            btnRefreshAI.Click += (s, e) => { AIEngine.InvalidateCache(); _cachedPredict = null; _cachedEnsemble = null; ShowHome(); };
        ...
        private void EnsurePredictCached()
        {
            ...
            if (_cachedEnsemble == null)
            {
                _cachedEnsemble = EnsemblePredictionService.Predict();
            }
        }
